<template>
  <div>
    ...
    <el-table :data="data.content" :highlight-current-row="highlightCurrentRow" @selection-change="selectionChange" 
          ...
          :show-overflow-tooltip="showOverflowTooltip" :min-height="height" :max-height="maxHeight"  :size="size" :align="align" style="width:100%;" >
            ...
            <template slot-scope="scope">
                <template v-if="!column.render">
                      <template v-if="column.formatter">
                            <div v-html="column.formatter(scope.row, column,scope.row[column.prop],index)"></div>
                      </template>
                      <template v-else>
    ...
    <div class="toolbar" style="padding:10px;">
      ...
      <el-pagination layout="total, prev, pager, next, jumper" @current-change="refreshPageRequest" @size-change="handleSizeChange"
        :current-page="pageRequest.pageNum" :page-size="pageRequest.pageSize" :page-sizes="[5,10, 20, 30, 40]" :total="data.totalSize" style="float:right;">
      </el-pagination>
    </div>
  </div>
</template>
