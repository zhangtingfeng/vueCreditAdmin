...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            submitStatus() {
                var this_ = this;
                let ids = this.checked.map(item => item.dynamic_id).toString();
...
*/
            ...
            initColumns: function () {
                this.columns = [
                    {prop: "dynamic_id", label: "编号", minWidth: 120},
                    ...
                    },
                    {
                        ...
                        label: "类型",
                        minWidth: 120,
                        formatter: this.showdynamic_type
                    },
