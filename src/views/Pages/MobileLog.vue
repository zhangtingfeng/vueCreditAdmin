    ...
    <div class="toolbar" style="float:left;padding-top:10px;padding-left:15px;">
      <el-form :inline="true" :model="filters" ref="filters" class="form">
        <el-form-item prop="mobile">
          <el-input v-model="filters.mobile" auto-complete="off" placeholder="电话号码"></el-input>
        </el-form-item>
        <el-form-item prop="shopname">
          <el-input v-model="filters.shop_name" auto-complete="off" placeholder="商铺名称"></el-input>
        </el-form-item>
        <el-form-item>
          <kt-button
            icon="fa fa-search"
  ...
  methods: {
    ...
    initColumns: function() {
      this.columns = [
        ...
        { prop: "mobile", label: "拨打电话", minWidth: 220 },
        { prop: "create_time", label: "拨打时间", minWidth: 220 },
      ];
      var temp = [];
