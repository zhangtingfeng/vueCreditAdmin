    ...
    <span class="toolbar">
      ...
      >
        ...
        <el-menu-item index="3" v-popover:popover-message>
          <!-- 我的私信 -->
          <!-- <el-badge :value="warnSize" :max="99" class="badge" type="success">
            <li style="color:#fff;" class="fa fa-envelope-o fa-lg"></li>
          </el-badge>
          <el-popover ref="popover-message" placement="bottom-end" trigger="click" >
            <message-panel @changeWarnSize="changeWarnSize"></message-panel>
          </el-popover> -->
        </el-menu-item>
        <el-menu-item index="4" v-popover:popover-notice>
          <!-- 系统通知 -->
          <!-- <el-badge :value="errorSize" :max="99" class="badge" type="success">
            <li style="color:#fff;" class="fa fa-bell-o fa-lg"></li>
          </el-badge>
          <el-popover ref="popover-notice" placement="bottom-end" trigger="click">
            <notice-panel @changeErrorSize="changeErrorSize"></notice-panel>
          </el-popover> -->
        </el-menu-item>
